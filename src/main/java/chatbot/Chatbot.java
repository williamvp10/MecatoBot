...
//default case
        ...
        if (userUtterance.matches("hola")) {
            userAction.add("userIntent", new JsonPrimitive("Uhola"));
        } else if (userUtterance.matches("nota")) {
            userAction.add("userIntent", new JsonPrimitive("Unota"));
        }
        return userAction;
    }
    ...
    public void updateContext(JsonObject userAction) {
        ...
        if (userIntent.equals("Uhola")) {
            context.add("currentTask", new JsonPrimitive("Uhola"));
        } else if (userIntent.equals("Unota")) {
            context.add("currentTask", new JsonPrimitive("Unota"));
        }
    }
    ...
    public void identifyBotIntent() {
        ...
        if (currentTask.equals("Uhola")) {
            context.add("botIntent", new JsonPrimitive("Uhola"));
        } else if (currentTask.equals("Unota")) {
            context.add("botIntent", new JsonPrimitive("Unota"));
        }
    }
    ...
    public JsonObject getBotOutput() throws IOException {
        ...
        String botUtterance = "";
        String type = "";
        if (botIntent.equals("Uhola")) {
            botUtterance = "hola lindo";
            type = "Uhola";
            buttons = null;
        } else if (botIntent.equals("Unota")) {
            botUtterance = "su nota es 5";
            type = "Unota";
            buttons = null;
        }
...
//        } else if (currentTask.equals("tipos")) {
//            context.add("botIntent", new JsonPrimitive("requestTipo"));
//        } else if (currentTask.equals("ingredientes")) {
